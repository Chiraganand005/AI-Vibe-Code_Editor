...
const MainPlaygroundPage = () => {
  ...
  const handleSave = useCallback(
   ...
   const updatedTemplateData = JSON.parse(
        ...
        const updateItemsContent = (items: TemplateItem[]): TemplateItem[] =>
          items.map((item) => {
...
// Update open files
  ...
  const handleCloseAllFilesClick = () => {
      ...
      <>
               ...
               />
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuSeparator />
                    <DropdownMenuItem onClick={handleCloseAllFilesClick}>
                      Close All Files
                    </DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
        ...
        <AlertDialog open={showUnsavedWarning} onOpenChange={setShowUnsavedWarning}>
          <AlertDialogContent className="bg-zinc-950 border-zinc-800 text-zinc-100 max-w-md">
            <AlertDialogHeader>
              <AlertDialogTitle className="text-xl font-bold text-zinc-100">Unsaved Changes</AlertDialogTitle>
              <AlertDialogDescription className="text-zinc-400">
                You have unsaved changes in your workspace. Do you want to save your project files before redirecting to the dashboard?
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter className="flex flex-col-reverse sm:flex-row gap-2 mt-4">
              <AlertDialogCancel 
                onClick={() => setShowUnsavedWarning(false)}
                className="bg-transparent border-zinc-800 text-zinc-400 hover:bg-zinc-900 hover:text-zinc-100 transition-colors"
              >
                Cancel
              </AlertDialogCancel>
              <AlertDialogAction 
              ...
              <AlertDialogAction 
                ...
                className="bg-[#E93F3F] hover:bg-[#E93F3F]/90 text-white transition-colors"
              >
                Save & Exit
              </AlertDialogAction>
            </AlertDialogFooter>
